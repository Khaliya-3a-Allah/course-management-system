 ...
 * Each icon accepts an optional `size` prop (defaults to 18px).
 */
...
export function CapIcon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M3 9.5 12 5l9 4.5L12 14 3 9.5Z" />
      <path d="M6.5 11.1V15c0 1.8 2.7 3.3 5.5 3.3s5.5-1.5 5.5-3.3v-3.9" />
    </svg>
  );
}
...
export function SunIcon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M12 2v2M12 20v2m-7.07-14.07 1.41 1.41m12.73 12.73 1.41 1.41M2 12h2m16 0h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41" />
    </svg>
  );
}
...
export function StarIcon({ size = 18, filled = false, color }) {
  return (
    <svg
      width={size}
      height={size}
...
export function DiamondIcon({ size = 20 }) {
  return (

...
export default function ColdStartBanner() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed top-0 left-0 right-0 z-50 px-4 py-2 text-center text-[0.82rem] text-[#f6c56b] bg-[linear-gradient(90deg,rgba(217,119,6,0.18),rgba(245,158,11,0.14))] border-b border-[rgba(245,158,11,0.35)] backdrop-blur-sm"
    >
      <span
